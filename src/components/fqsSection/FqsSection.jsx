import ButtonAns from "./ButtonAns";
import ButtonFqs from "./ButtonFqs";
import { SvgDownArrow, SvgUpArrow } from "./svgFqs/SvgFqs";

export default function FqsSection() {
  return (
        ...
        <div className="max-w-screen-md mx-auto">
          ...
          >
            <ButtonFqs
              ...
              fqs="Can I use Landwind in open-source projects?"
            />

            <ButtonAns
              href="#"
              Ans="Landwind is an open-source library of interactive components built on
          top of Tailwind CSS including buttons, dropdowns, modals, navbars, and
          more."
              readMore="Check out this guide to learn how to"
              title="get started"
              detail="and start developing websites even faster with components on top of
          Tailwind CSS."
            />
            ...
            <ButtonFqs
              ...
              fqs="Is there a Figma file available?"
            />
            ...
            <ButtonFqs
              Icon={SvgDownArrow}
              className="flex items-center justify-between w-full py-5 font-medium text-left text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400"
              fqs=" What are the differences between Landwind and Tailwind UI?"
            />
            ...
            <ButtonFqs
              Icon={SvgDownArrow}
              className="flex items-center justify-between w-full py-5 font-medium text-left text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400"
              fqs="What about browser support?"
            />
